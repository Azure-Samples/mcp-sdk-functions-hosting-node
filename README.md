...
* [Node.js](https://nodejs.org/) 22 or above
...
1. Run `func start` to start the server locally
...
1. Ask Copilot "What is the weather in NYC?". It should call one of the weather tools to help answer.
